...
Written 14 September 2026 for newsroom.sgit.ai v0.3.10; the contract it references is
...
```
{
  "delivery": { "id", "tool": "perplexity", "model", "date", "brief": "13__research-brief-for-perplexity.md v1",
...
next section in the order above.
